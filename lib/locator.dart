...
import 'data/repositores/cities_local_repository.dart';
import 'data/repositores/search_repository_impl.dart';
import 'data/repositores/sort_local_repository.dart';
...
setupRepository() {
  locator.registerSingleton<ISortLocalRepository>(SortLocalRepositoryImpl());
  locator.registerSingleton<ICitiesLocalRepository>(CitiesLocalRepositoryImpl());
