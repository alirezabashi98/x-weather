...
import 'package:x_weather/utils/extensions/ConvertHistory.dart';
      ...
      body: BlocBuilder<DetailBloc, DetailState>(
        builder: (context, state) {
          return RefreshIndicator(
            onRefresh: () async{
              context.read<DetailBloc>().add(DetailRequestWeatherTodayEvent(cityName));
            },
            child: Stack(
                                ...
                                return SizedBox(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return ItemDetailWeatherHourlyForecastWidget(isNow: index==0,forecastWeather: forecastWeather[index],);
                                    },
                                  ),
                                );
                              })
...
class ItemDetailWeatherHourlyForecastWidget extends StatelessWidget {
  final bool? isNow;
  final ForecastWeatherResponseModel forecastWeather;
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                const SizedBox(width: double.infinity),
                Text(
                  isNow! ? 'Now' : forecastWeather.dtTxt.getHoursFromTheWholeDate(),
                  style: const TextStyle(fontSize: 15, color: Colors.white),
                ),
                Image.asset('assets/images/ic_${forecastWeather.icon}.png',height: 48,),
                Text(
