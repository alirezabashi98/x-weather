          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Text(
                  'Mostly Clear',
                  style: TextStyle(color: Constants.secondary, fontSize: 20),
                ),
                Row(
                  ...
                  child: Column(
                    children: [
                      ...
                      Center(
                        ...
                        'Hourly Forecast',
                        style:
                            TextStyle(fontSize: 20, color: Constants.secondary),
                      )),
                      ...
                      SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: const [
                            ItemDetailWeatherHourlyForecastWidget(isNow: true),
                            ItemDetailWeatherHourlyForecastWidget(),
                            ItemDetailWeatherHourlyForecastWidget(),
                            ItemDetailWeatherHourlyForecastWidget(),
                            ItemDetailWeatherHourlyForecastWidget(),
                            ItemDetailWeatherHourlyForecastWidget(),
